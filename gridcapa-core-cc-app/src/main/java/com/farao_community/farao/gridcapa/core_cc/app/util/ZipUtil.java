...
public final class ZipUtil {
    ...
    public static void unzipFile(Path zipFilePath, Path destDirectory) {
        if (!destDirectory.toFile().exists() && !destDirectory.toFile().mkdir()) {
            ...
            throw new RaoIntegrationException(String.format("Cannot create destination directory '%s'", destDirectory));
        }
        try (ZipInputStream zipIn = new ZipInputStream(new FileInputStream(zipFilePath.toFile()))) {
            ...
            throw new RaoIntegrationException(String.format("Error while extracting file '%s'", zipFilePath.getFileName()), e);
        }
    }
    ...
    public static void deletePath(Path path) {
        try {
            ...
            throw new RaoIntegrationException("Exception occurred while trying to delete recursively from path: " + path.toString());
        }
    }
    ...
    public static byte[] zipDirectory(String inputDirectory) {
        try (ByteArrayOutputStream os = new ByteArrayOutputStream();
            ...
            throw new RaoIntegrationException(String.format("Exception occurred while compressing directory '%s'", inputDirectory), e);
        }
    }
    ...
    private static void recursiveZip(String dir2zip, ZipOutputStream zos, String referencePath) {
        ...
        for (String fileOrDir : dirList) {
            ...
            try (FileInputStream fis = new FileInputStream(f)) {
                ...
                throw new RaoIntegrationException(e.getMessage(), e);
            }
        }
    }
